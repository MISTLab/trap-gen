...
class TestRegs(unittest.TestCase):
    ...
    def testOk(self):
        ...
        regs = processor.AliasRegBank('REGS', 16, 32, 'RB[0-15]')
    ...
    def testAliasReg(self):
        ...
        regs = processor.AliasRegBank('REGS', 16, 32, 'RB[0-15]')
        proc.addAliasRegBank(regs)
        PC = processor.AliasRegister('PC', 32, 'UNEXISTING')
        proc.addAliasReg(PC)
        abi = processor.ABI('REGS[0]', 'REGS[0-3]', 'RB[15]')
        abi.addVarRegsCorrespondence({'REGS[0-15]': (0, 15), 'CPSR': (25, 25)})
        proc.setABI(abi)
    ...
    def testAliasRegBank(self):
        ...
        regs = processor.AliasRegBank('REGS', 16, 32, 'RB[0-15]')
        proc.addAliasRegBank(regs)
        PC = processor.AliasRegister('PC', 32, 'UNEXISTING[15]')
        proc.addAliasReg(PC)
        abi = processor.ABI('REGS[0]', 'REGS[0-3]', 'RB[15]')
        abi.addVarRegsCorrespondence({'REGS[0-15]': (0, 15), 'CPSR': (25, 25)})
        proc.setABI(abi)
    ...
    def testAliasBankRegBank(self):
        ...
        cpsr.setDefaultValue(0x000000D3)
        proc.addRegister(cpsr)
        regs = processor.AliasRegBank('REGS', 16, 32, 'UNEXISTING[0-15]')
        proc.addAliasRegBank(regs)
        PC = processor.AliasRegister('PC', 32, 'REGS[15]')
        proc.addAliasReg(PC)
        abi = processor.ABI('REGS[0]', 'REGS[0-3]', 'RB[15]')
        abi.addVarRegsCorrespondence({'REGS[0-15]': (0, 15), 'CPSR': (25, 25)})
        proc.setABI(abi)
    ...
    def testAliasBankMixed(self):
        ...
        cpsr.setDefaultValue(0x000000D3)
        proc.addRegister(cpsr)
        regs = processor.AliasRegBank('REGS', 16, 32, ('RB[0-14]', 'UNEXISTING'))
        proc.addAliasRegBank(regs)
        PC = processor.AliasRegister('PC', 32, 'REGS[15]')
        proc.addAliasReg(PC)
        abi = processor.ABI('REGS[0]', 'REGS[0-3]', 'RB[15]')
