...
cmn_shift_reg_Instr.addTest({'cond': 0xe, 's': 1, 'rn': 9, 'rm': 8, 'rs': 0, 'shift_op': 2}, {'REGS[0]': 0, 'REGS[9]': 3, 'REGS[8]': 0x80000000}, {'CPSR': 0x20000000})
...
cmn_shift_reg_Instr.addTest({'cond': 0xe, 's': 1, 'rn': 9, 'rm': 8, 'rs': 1, 'shift_op': 3}, {'REGS[0]': 16,'REGS[9]': 3, 'REGS[8]': 0x00020020}, {'CPSR': 0x00000000})
#End Test
