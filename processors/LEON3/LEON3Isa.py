...
ldsb_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
ldsb_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
ldsh_imm_Instr = trap.Instruction('LDSH_imm', True, frequency = 2)
...
ldsh_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
ldsh_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
ldub_imm_Instr = trap.Instruction('LDUB_imm', True, frequency = 4)
...
ldub_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
lduh_imm_Instr = trap.Instruction('LDUH_imm', True, frequency = 2)
...
lduh_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
lduh_reg_Instr = trap.Instruction('LDUH_reg', True, frequency = 1)
...
lduh_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
ld_imm_Instr = trap.Instruction('LD_imm', True, frequency = 7)
...
ld_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
ld_reg_Instr = trap.Instruction('LD_reg', True, frequency = 4)
...
ld_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
ldd_imm_Instr = trap.Instruction('LDD_imm', True, frequency = 1)
...
ldd_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
ldd_reg_Instr = trap.Instruction('LDD_reg', True, frequency = 1)
...
ldd_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
ldsba_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
ldsha_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
lduba_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
lduha_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
lda_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
ldda_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
stb_imm_Instr = trap.Instruction('STB_imm', True, frequency = 3)
...
stb_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
sth_imm_Instr = trap.Instruction('STH_imm', True, frequency = 2)
...
sth_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
sth_reg_Instr = trap.Instruction('STH_reg', True, frequency = 1)
...
sth_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
st_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
st_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
std_imm_Instr = trap.Instruction('STD_imm', True, frequency = 2)
...
std_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
std_reg_Instr = trap.Instruction('STD_reg', True, frequency = 2)
...
std_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
stba_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
stha_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
sta_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
stda_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
ldstub_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
ldstub_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
ldstuba_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
swap_imm_Instr.setCode(opCodeExec, 'exception')
swap_imm_Instr.setCode(opCodeException, 'execute')
swap_imm_Instr.setCode(opCodeWb, 'wb')
swap_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
swap_reg_Instr.setCode(opCodeExec, 'exception')
swap_reg_Instr.setCode(opCodeException, 'execute')
swap_reg_Instr.setCode(opCodeWb, 'wb')
swap_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
swapa_reg_Instr.setCode(opCodeExec, 'exception')
swapa_reg_Instr.setCode(opCodeException, 'execute')
swapa_reg_Instr.setCode(opCodeWb, 'wb')
swapa_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
sethi_Instr = trap.Instruction('SETHI', True, frequency = 6)
...
""")
and_imm_Instr = trap.Instruction('AND_imm', True, frequency = 3)
...
""")
and_reg_Instr = trap.Instruction('AND_reg', True, frequency = 1)
...
andcc_imm_Instr = trap.Instruction('ANDcc_imm', True, frequency = 2)
...
result = rs1_op & ~(SignExtend(simm13, 13));
""")
andn_imm_Instr = trap.Instruction('ANDN_imm', True, frequency = 1)
...
result = rs1_op & ~rs2_op;
""")
andn_reg_Instr = trap.Instruction('ANDN_reg', True, frequency = 2)
...
andncc_imm_Instr = trap.Instruction('ANDNcc_imm', True, frequency = 1)
...
andncc_reg_Instr = trap.Instruction('ANDNcc_reg', True, frequency = 1)
...
orcc_imm_Instr = trap.Instruction('ORcc_imm', True, frequency = 2)
...
orcc_reg_Instr = trap.Instruction('ORcc_reg', True, frequency = 1)
...
result = rs1_op | ~(SignExtend(simm13, 13));
""")
orn_imm_Instr = trap.Instruction('ORN_imm', True, frequency = 1)
...
result = rs1_op | ~rs2_op;
""")
orn_reg_Instr = trap.Instruction('ORN_reg', True, frequency = 1)
...
orncc_imm_Instr = trap.Instruction('ORNcc_imm', True, frequency = 1)
...
orncc_reg_Instr = trap.Instruction('ORNcc_reg', True, frequency = 1)
...
result = rs1_op ^ rs2_op;
""")
xor_reg_Instr = trap.Instruction('XOR_reg', True, frequency = 2)
...
xorcc_imm_Instr = trap.Instruction('XORcc_imm', True, frequency = 1)
...
xorcc_reg_Instr = trap.Instruction('XORcc_reg', True, frequency = 1)
...
result = rs1_op ^ ~(SignExtend(simm13, 13));
""")
xnor_imm_Instr = trap.Instruction('XNOR_imm', True, frequency = 1)
...
result = rs1_op ^ ~rs2_op;
""")
xnor_reg_Instr = trap.Instruction('XNOR_reg', True, frequency = 1)
...
xnorcc_imm_Instr = trap.Instruction('XNORcc_imm', True, frequency = 1)
...
xnorcc_reg_Instr = trap.Instruction('XNORcc_reg', True, frequency = 1)
...
""")
sll_imm_Instr = trap.Instruction('SLL_imm', True, frequency = 4)
...
sll_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
sll_reg_Instr = trap.Instruction('SLL_reg', True, frequency = 2)
...
sll_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
srl_imm_Instr = trap.Instruction('SRL_imm', True, frequency = 2)
...
srl_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
srl_reg_Instr = trap.Instruction('SRL_reg', True, frequency = 1)
...
srl_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
sra_imm_Instr = trap.Instruction('SRA_imm', True, frequency = 3)
...
sra_imm_Instr.addBehavior(IncrementPC, 'fetch')
...
""")
sra_reg_Instr = trap.Instruction('SRA_reg', True, frequency = 1)
...
sra_reg_Instr.addBehavior(IncrementPC, 'fetch')
...
addcc_imm_Instr = trap.Instruction('ADDcc_imm', True, frequency = 2)
...
addcc_reg_Instr = trap.Instruction('ADDcc_reg', True, frequency = 1)
...
""")
addx_imm_Instr = trap.Instruction('ADDX_imm', True, frequency = 1)
...
addx_reg_Instr = trap.Instruction('ADDX_reg', True, frequency = 1)
...
addxcc_imm_Instr = trap.Instruction('ADDXcc_imm', True, frequency = 1)
...
addxcc_reg_Instr = trap.Instruction('ADDXcc_reg', True, frequency = 1)
...
result = rs1_op - rs2_op;
""")
sub_imm_Instr = trap.Instruction('SUB_imm', True, frequency = 2)
...
sub_reg_Instr = trap.Instruction('SUB_reg', True, frequency = 3)
...
subcc_imm_Instr = trap.Instruction('SUBcc_imm', True, frequency = 4)
...
subcc_reg_Instr = trap.Instruction('SUBcc_reg', True, frequency = 4)
...
subx_reg_Instr = trap.Instruction('SUBX_reg', True, frequency = 1)
...
subxcc_imm_Instr = trap.Instruction('SUBXcc_imm', True, frequency = 1)
...
subxcc_reg_Instr = trap.Instruction('SUBXcc_reg', True, frequency = 1)
...
Ybp = yNew;
""")
mulscc_imm_Instr = trap.Instruction('MULScc_imm', True, frequency = 1)
...
mulscc_reg_Instr = trap.Instruction('MULScc_reg', True, frequency = 1)
...
result = resultTemp & 0x00000000FFFFFFFF;
""")
umul_imm_Instr = trap.Instruction('UMUL_imm', True, frequency = 1)
...
umul_reg_Instr = trap.Instruction('UMUL_reg', True, frequency = 1)
...
smul_reg_Instr = trap.Instruction('SMUL_reg', True, frequency = 3)
...
umulcc_imm_Instr = trap.Instruction('UMULcc_imm', True, frequency = 1)
...
umulcc_reg_Instr = trap.Instruction('UMULcc_reg', True, frequency = 1)
...
smulcc_imm_Instr = trap.Instruction('SMULcc_imm', True, frequency = 1)
...
smulcc_reg_Instr = trap.Instruction('SMULcc_reg', True, frequency = 1)
...
udiv_reg_Instr = trap.Instruction('UDIV_reg', True, frequency = 1)
...
sdiv_imm_Instr = trap.Instruction('SDIV_imm', True, frequency = 1)
...
""")
save_imm_Instr = trap.Instruction('SAVE_imm', True, frequency = 4)
...
restore_reg_Instr = trap.Instruction('RESTORE_reg', True, frequency = 4)
...
""")
branch_Instr = trap.Instruction('BRANCH', True, frequency = 6)
...
#endif
""")
call_Instr = trap.Instruction('CALL', True, frequency = 4)
...
""")
jump_imm_Instr = trap.Instruction('JUMP_imm', True, frequency = 3)
...
jump_reg_Instr = trap.Instruction('JUMP_reg', True, frequency = 2)
...
NPC = targetAddr;
""")
rett_imm_Instr = trap.Instruction('RETT_imm', True, frequency = 1)
...
rett_reg_Instr = trap.Instruction('RETT_reg', True, frequency = 1)
