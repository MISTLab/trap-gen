...
#OPER with SCForm
oper_SCform = trap.MachineCode([('primary_opcode', 6), ('reserved1', 5), ('reserved2', 5), ('reserved3',14), ('1',1), ('reserved4',1)])
...
oper_Dform_2 = trap.MachineCode([('primary_opcode', 6), ('rt', 5), ('ra', 5), ('im_si',16)])
oper_Dform_2.setVarField('rt', ('GPR', 0), 'out')
oper_Dform_2.setVarField('ra', ('GPR', 0), 'in')
oper_Dform_2.setVarField('im_si', ('GPR', 0), 'in')
...
oper_Xform_2 = trap.MachineCode([('primary_opcode', 6), ('rt', 5), ('ra', 5), ('rb',5), ('xo',10), ('reserved1',1)])
oper_Xform_2.setVarField('rt', ('GPR', 0), 'out')
oper_Xform_2.setVarField('ra', ('GPR', 0), 'in')
oper_Xform_2.setVarField('rb', ('GPR', 0), 'in')
oper_Xform_3 = trap.MachineCode([('primary_opcode', 6), ('rt', 5), ('ra', 5), ('nb',5), ('xo',10), ('reserved1',1)])
oper_Xform_3.setVarField('rt', ('GPR', 0), 'out')
oper_Xform_3.setVarField('ra', ('GPR', 0), 'in')
#oper_Xform_3.setVarField('rb', ('GPR', 0), 'in')
oper_Xform_4 = trap.MachineCode([('primary_opcode', 6), ('rt', 5), ('ra', 5), ('ws',5), ('xo',10), ('reserved1',1)])
...
oper_Xform_9 = trap.MachineCode([('primary_opcode', 6), ('rs', 5), ('ra', 5), ('rb',5), ('xo',10), ('reserved1',1)])
#oper_Xform_9.setVarField('rt', ('GPR', 0), 'out')
oper_Xform_9.setVarField('ra', ('GPR', 0), 'in')
oper_Xform_9.setVarField('rb', ('GPR', 0), 'in')
oper_Xform_10 = trap.MachineCode([('primary_opcode', 6), ('rs', 5), ('ra', 5), ('nb',5), ('xo',10), ('reserved1',1)])
#oper_Xform_10.setVarField('rt', ('GPR', 0), 'out')
oper_Xform_10.setVarField('ra', ('GPR', 0), 'in')
#oper_Xform_10.setVarField('rb', ('GPR', 0), 'in')
oper_Xform_11 = trap.MachineCode([('primary_opcode', 6), ('rs', 5), ('ra', 5), ('ws',5), ('xo',10), ('reserved1',1)])
