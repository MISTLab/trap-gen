...
#~ processor.setISA(ARMIsa2.isa) #lets set the instruction set
...
processor.setWordsize(4, 8) #4 bytes per word, 8 bits per byte
processor.setISA(MICROBLAZEIsa2.isa) #lets set the instruction set
...
regBank = trap.RegisterBank('GPR', 32, 32) #GPR is the name, 30 registers of 32 bits
