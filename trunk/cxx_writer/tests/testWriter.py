...
class TestWriter(unittest.TestCase):
    ...
    def testLineLength(self):
        ...
        self.assertEqual(lines[0], '{\n')
        self.assertEqual(lines[1], '    {\n')
        self.assertEqual(lines[2], '        one two three four five six seven eight nine ten eleven twelve thirteen fourteen fifteen sixteen\n')
        self.assertEqual(lines[3], '            seventeen eighteen nineteen twentypippo\n')
