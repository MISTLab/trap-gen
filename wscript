...
def configure(conf):
    ...
    conf.check_boost(lib=boostLibs, static='both', min_version='1.35.0', max_version='1.39.9', mandatory = 1, errmsg = 'Unable to find ' + boostLibs + ' boost libraries of at least version 1.35, please install them and specify their location with the --boost-includes and --boost-libs configuration options')
